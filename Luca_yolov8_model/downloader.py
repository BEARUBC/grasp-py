...
# make sure to run this in the terminal if these libraries are not on your env:
# conda env update --name <your env name> -f environment.yaml
import boto3
import botocore
import tqdm
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Filename that contains the split + image IDs of the images to "
